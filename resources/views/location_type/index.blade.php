...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-5">
                <div class="card-header bg-transparent"><h3 class="mb-0">Location Type information</h3></div>
                <div class="card-body">
                    {!! Form::open(['route' => 'locationstype.store']) !!}
                    <div class="pl-lg-0">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            {{ Form::label('loc_type_code', 'Code', ['class' => 'form-control-label required']) }}
        ...
        $(function() {
            var table = $('.data-table').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'loc_type_enabled',
                        name: 'loc_type_enabled'
                    },
